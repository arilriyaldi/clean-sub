    ...
    <section id="langganan" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
          {plans.map((plan, index) => (
            ...
            >
              ...
              <button className={`w-full py-4 rounded-2xl font-black text-lg transition-all cursor-pointer ${
                plan.popular 
        ...
        <div className="mt-16 bg-slate-50 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 border border-slate-100">
          ...
          <button className="bg-slate-900 text-white px-8 py-4 rounded-2xl font-bold whitespace-nowrap hover:bg-slate-800 transition-all cursor-pointer">
            Hubungi Tim Sales
          </button>
        </div>
      </div>
